package com.busted_moments.core.http.requests.serverlist;
...
public class ServerList extends BaseModel implements Collection<World> {
    @Key private Map<String, World> servers;
    ...
    @AbstractRequest.Definition(route = "https://athena.wynntils.com/cache/get/serverList", cache_length = 0, ratelimit = RateLimit.NONE)
