...
public class MapTemplate extends JsonTemplate implements Collection<TerritoryTemplate> {
   @Entry("templateUUID")
   private UUID uuid;
   @Entry
   private int version;
   ...
   @com.busted_moments.core.api.internal.Request.Definition(route = "https://thesimpleones.net/api/mapTemplates/%s", ratelimit = RateLimit.NONE, cache_length = 15)
